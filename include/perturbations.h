...
struct perturbations
{
  ...
  short has_source_CMaDE_delta_dm; /**< do we need source for delta of CMaDE dark matter? */
  short has_source_CMaDE_theta_dm; /**< do we need source for theta of CMaDE dark matter? */
  ...
  //Claudio Salas Pérez: 06/10/2025
  // Primer intento de modificar perturnaciones
  int index_tp_CMaDE_delta_dm;
  int index_tp_CMaDE_theta_dm;
...
struct perturbations_vector
{
  ...
  /*Claudio Salas Pérez: 06/10/2025: CMaDE perturbation variables */
  int index_pt_CMaDE_delta_dm;
  int index_pt_CMaDE_theta_dm;
...
struct perturbations_workspace
{
  ...
  */
  ...
  //@{
  double delta_last_valid;
double a_last_valid;
short int printed_transition;
  FILE *f_diag;
