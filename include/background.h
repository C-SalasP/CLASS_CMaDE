...
struct background
{
  ...
  // Aqui agrego apuntadores para mis densidades de materia y energia oscura para el modelo CMaDE
  // Estis ubduces se usan en Pveback
  int index_bg_CMaDE_rho_dm;         /**< dark matter density */
  int index_bg_CMaDE_rho_de;         /**< dark energy density */
  ...
  //Esto nos sirve para poder guardar las presiones efectivas y los parametros de acoplamiento
  // de materia y energia oscura en el modelo CMaDE
  int index_bg_CMaDE_P_dm;
  int index_bg_CMaDE_W_eff_dm;

  int index_bg_CMaDE_P_de;
  int index_bg_CMaDE_W_eff_de;

  int index_bg_CMaDE_M_prime;
  ...
  int bi_size;          /**< Number of {B}+{C} parameters */
   ...
   //  Claudio Salas Pérez 28/09/2025
  // Aqui agrego apuntadores para mis densidades de materia y energia oscura que se usaran en la parte diferencial para el modelo CMaDE
  // Estos unduces se usan en y[]
  int index_bi_CMaDE_rho_dm;         /**< dark matter density */
  int index_bi_CMaDE_rho_de;         /**< dark energy density */
  ...
  //  Claudio Salas Pérez 28/09/2025
  // Aqui agrego un flag para el modelo CMaDE
  short has_CMaDE;     /**< presence of coupled dark matter and dark energy? */
  short save_perturbations;
  //@}
